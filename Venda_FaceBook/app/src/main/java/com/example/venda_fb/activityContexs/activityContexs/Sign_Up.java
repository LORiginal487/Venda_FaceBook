...
public class Sign_Up extends AppCompatActivity {
    ...
    private void signUpMeth(){
        ...
        user.put(Constants.Key_Surname, surname);
        ...
        usersCol.document(email).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                showToast("welcome!");

                managePreferences.putBoolean(Constants.Key_Is_Signed_In, true);
                managePreferences.putString(Constants.Key_Users_Id, usersCol.getId());
    ...
    public void checkEmail(){
        loading(true);
        DocumentReference docRef = db.collection(Constants.Key_Collection_Users).document(email);
